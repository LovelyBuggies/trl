...
from trl import GRPOConfig, GRPOTrainer, reward_length, reward_capitalization
import torch
import argparse
import yaml
import os
...
def main():
    ...
    run_name = config.get('run_name', f'qwen-0.5b-grpo')
    if use_wandb:
    ...
    output_dir = config.get('save_dir', f"qwen-0.5b-grpo")
